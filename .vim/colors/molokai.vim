...
if &t_Co > 255
   ...
   " Highlight color for /searches
   hi IncSearch       ctermfg=11  ctermbg=16 
   ...
   " hilighted color after search is preformed
   hi Search          ctermfg=253 ctermbg=1
   ...
   " NOTE: everything past this point was added by STU
